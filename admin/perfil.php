...
</style></head><body><nav class="navbar navbar-dark top"><div class="container-fluid px-3 px-lg-4 py-2"><a class="navbar-brand fw-bold" href="<?=h(urlAplicacion('/admin/dashboard.php'))?>"><i class="bi bi-mortarboard-fill me-2"></i>Studia360</a><div class="d-flex gap-2"><a class="btn btn-light btn-sm" href="<?=h(urlAplicacion('/admin/dashboard.php'))?>"><i class="bi bi-arrow-left me-1"></i>Dashboard</a><a class="btn btn-outline-light btn-sm" href="<?=h(urlAplicacion('/cerrar_sesion.php'))?>">Salir</a></div></div></nav>
