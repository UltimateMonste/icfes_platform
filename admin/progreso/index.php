...
<style>
/* Todas las superficies del módulo respetan el modo oscuro global. */
body.s360-admin .cardx,
body.s360-admin .stat,
body.s360-admin .detail{
    background:var(--adm-surface,#fff);
    color:var(--adm-text,#26364a);
    border-color:var(--adm-border,#dce5f0);
}
body.s360-admin .muted{color:var(--adm-muted,#718096)!important}
...
body.s360-admin .form-control::placeholder{color:var(--adm-muted,#718096)}
...
body.s360-admin.adm-dark .detail{
    box-shadow:0 12px 30px rgba(0,0,0,.18);
}
body.s360-admin.adm-dark .stat{background:#172238;}
body.s360-admin.adm-dark .form-control,
body.s360-admin.adm-dark .form-select{color-scheme:dark;}
body.s360-admin.adm-dark .form-select option{background:#0f172a;color:#f1f5f9;}
body.s360-admin.adm-dark .table{--bs-table-bg:transparent;--bs-table-color:#f1f5f9;--bs-table-border-color:#2b3951;}
body.s360-admin.adm-dark .table .text-bg-light{background:#202c42!important;color:#dbe5f1!important;}
body.s360-admin.adm-dark .progress{background:#26344b;}
body.s360-admin.adm-dark .border-bottom{border-color:#2b3951!important;}
</style>
