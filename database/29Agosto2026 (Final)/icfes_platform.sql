...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-08-2026 a las 09:47:24
...
INSERT INTO `progreso` (`id_progreso`, `id_usuario`, `id_tema`, `recursos_vistos`, `evaluaciones_realizadas`, `porcentaje_avance`, `ultima_actividad`) VALUES
(1, 7, 19, 0, 0, 0.00, '2026-08-28 01:23:09');
...
(2, 'Administrador', 'Principal', 'admin@icfes.local', '$2y$10$WsIg1GC05G6XeRDJGfKFYOqKVZZfeb8FEH6.2LoYGscAZuDyci2Va', '11', NULL, 'avatar_default.png', 1, 0, 1, '2026-08-13 04:46:03', 'ADMIN001', 1, 1, 0, 'Activo', '2026-08-29 02:40:09', NULL, NULL),
...
(7, 'Pepe', 'Pepencio', 'popis@gmail.com', '$2y$10$NWlpgDVF84RUIYiN9b5UNeHQeoor99nhpC1mzZXs4z8POosz8J3se', '9', 15, 'avatar1.png', 1, 0, 1, '2026-08-16 06:21:14', '12345', 2, 1, 0, 'Activo', '2026-08-29 02:26:01', '2026-08-26 22:31:44', NULL),
(8, 'Joel', 'Rivera', 'juan@correo.com', '$2y$10$bRyqLOPwxxDXmWMNI.VmauQf5py5FKDD2OAH5lrMTsroqBk30r4.O', '11', 13, 'avatar_default.png', 1, 0, 1, '2026-08-28 07:10:19', '1073533196', 2, 1, 0, 'Activo', '2026-08-29 02:38:48', '2026-08-28 02:12:53', NULL);
...
--
ALTER TABLE `progreso`
  MODIFY `id_progreso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
