...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-09-2026 a las 09:51:17
...
INSERT INTO `avatares` (`id_avatar`, `id_nivel`, `nombre`, `imagen`, `puntos_requeridos`, `estado`) VALUES
(1, 1, 'Explorador', 'assets/uploads/avatares/catalogo_20260914074938_10a3f5e928dc.jpg', 0, 'Activo'),
(2, 2, 'Matemático', 'avatar2.png', 200, 'Activo'),
(3, 3, 'Científico', 'avatar3.png', 500, 'Activo'),
(4, 4, 'Investigador', 'avatar4.png', 900, 'Activo'),
(5, 5, 'Maestro ICFES', 'avatar5.png', 1500, 'Activo');
...
--
-- Estructura de tabla para la tabla `configuracion_gamificacion`
--

CREATE TABLE `configuracion_gamificacion` (
  `id_configuracion` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `configuracion_gamificacion`
--

INSERT INTO `configuracion_gamificacion` (`id_configuracion`, `clave`, `nombre`, `descripcion`, `puntos`, `estado`) VALUES
(1, 'entrar_tema', 'Interactuar con un tema', 'Primera interacción con cada tema', 10, 'Activo'),
(2, 'ver_recurso', 'Consultar un recurso', 'Primera consulta de cada recurso', 5, 'Activo'),
(3, 'completar_tema', 'Completar un tema', 'Al alcanzar el 100% del progreso', 25, 'Activo'),
(4, 'evaluacion', 'Completar evaluación', 'Puntos base por finalizar una evaluación', 20, 'Activo'),
(5, 'evaluacion_perfecta', 'Resultado perfecto', 'Bonificación adicional por obtener 100%', 30, 'Activo'),
(6, 'insignia', 'Obtener insignia', 'Puntos otorgados por una insignia', 0, 'Activo');
...
(7, 8, 'Tema completado: 47', NULL, 10, '2026-09-02 13:20:33'),
(8, 8, 'Tema completado: 48', NULL, 10, '2026-09-02 14:41:43'),
(9, 8, 'Tema completado: 7', NULL, 10, '2026-09-02 14:43:10'),
(10, 8, 'Tema completado: 9', NULL, 10, '2026-09-02 14:43:15'),
(11, 8, 'Tema completado: 44', NULL, 10, '2026-09-02 14:43:24'),
(12, 8, 'Tema completado: 45', NULL, 10, '2026-09-02 14:43:33'),
(13, 8, 'Tema completado: 16', NULL, 10, '2026-09-02 14:43:56'),
(14, 8, 'Tema completado: 17', NULL, 10, '2026-09-02 14:44:05'),
(15, 8, 'Tema completado: 18', NULL, 10, '2026-09-02 14:44:11'),
(16, 8, 'Tema completado: 35', NULL, 10, '2026-09-02 14:44:26'),
(17, 8, 'Tema completado: 34', NULL, 10, '2026-09-02 14:44:35'),
(18, 8, 'Tema completado: 19', NULL, 10, '2026-09-02 14:44:53'),
(19, 8, 'Tema completado: 20', NULL, 10, '2026-09-02 14:45:00'),
(20, 8, 'Tema completado: 21', NULL, 10, '2026-09-02 14:45:05');
...
INSERT INTO `insignias` (`id_insignia`, `id_materia`, `nombre`, `descripcion`, `imagen`, `criterio`, `puntos_otorgados`, `estado`) VALUES
(1, 1, 'Maestro de Matemáticas', 'Completaste todos los temas de Matemáticas correspondientes a tu grado.', NULL, 'materia_completa', 0, 'Activa'),
(2, 2, 'Maestro de Lectura', 'Completaste todos los temas de Lectura Crítica correspondientes a tu grado.', NULL, 'materia_completa', 0, 'Activa'),
(3, 3, 'Maestro de Ciencias', 'Completaste todos los temas de Ciencias Naturales correspondientes a tu grado.', NULL, 'materia_completa', 0, 'Activa'),
(4, 4, 'Maestro de Sociales', 'Completaste todos los temas de Sociales y Ciudadanas correspondientes a tu grado.', NULL, 'materia_completa', 0, 'Activa'),
(5, 5, 'Nativo Inglés', 'Completaste todos los temas de Inglés correspondientes a tu grado.', NULL, 'materia_completa', 0, 'Activa');
...
(7, 2, 'Restableció la contraseña del estudiante ID 8', '::1', '2026-09-02 14:24:25'),
(8, 2, 'Restableció la contraseña del estudiante ID 8', '::1', '2026-09-02 14:30:52');
...
(3, 8, 7, 0, 0, 100.00, 0, '2026-09-02 09:43:10', NULL),
(4, 8, 8, 0, 0, 100.00, 0, '2026-08-30 09:55:35', NULL),
(5, 8, 9, 0, 0, 100.00, 0, '2026-09-02 09:43:15', NULL),
(6, 8, 16, 0, 0, 100.00, 0, '2026-09-02 09:43:56', NULL),
(7, 8, 17, 0, 0, 100.00, 0, '2026-09-02 09:44:05', NULL),
(8, 8, 18, 0, 0, 100.00, 0, '2026-09-02 09:44:11', NULL),
...
(12, 8, 35, 0, 0, 100.00, 0, '2026-09-02 09:44:26', NULL),
(13, 8, 34, 0, 0, 100.00, 0, '2026-09-02 09:44:35', NULL),
(14, 8, 43, 0, 0, 100.00, 0, '2026-08-30 11:22:15', NULL),
(15, 8, 44, 0, 0, 100.00, 0, '2026-09-02 09:43:24', NULL),
(16, 8, 45, 0, 0, 100.00, 0, '2026-09-02 09:43:33', NULL),
(17, 8, 36, 0, 0, 100.00, 0, '2026-08-30 11:21:32', NULL),
(18, 8, 19, 2, 0, 100.00, 0, '2026-09-02 09:44:53', NULL),
(19, 7, 20, 0, 0, 10.00, 0, '2026-08-30 11:52:48', NULL),
(20, 7, 21, 0, 0, 10.00, 0, '2026-08-30 11:52:53', NULL),
(21, 8, 22, 0, 0, 10.00, 0, '2026-09-02 08:11:32', NULL),
(22, 8, 23, 0, 0, 10.00, 0, '2026-09-02 08:11:41', NULL),
(23, 8, 24, 0, 0, 10.00, 0, '2026-09-02 08:11:44', NULL),
(26, 8, 20, 0, 0, 100.00, 0, '2026-09-02 09:44:59', NULL),
(27, 8, 21, 0, 0, 100.00, 0, '2026-09-02 09:45:04', NULL),
(28, 8, 39, 0, 0, 10.00, 0, '2026-09-02 09:45:29', NULL);
...
CREATE TABLE `solicitudes_recuperacion` (
  ...
  `id_usuario` int(11) NOT NULL,
  `estado` enum('Pendiente','Gestionada','Cancelada') NOT NULL DEFAULT 'Pendiente',
...
INSERT INTO `solicitudes_recuperacion` (`id_solicitud`, `id_usuario`, `estado`, `mensaje_admin`, `fecha_solicitud`, `fecha_gestion`) VALUES
(1, 8, 'Cancelada', NULL, '2026-09-02 10:09:38', NULL),
(2, 1, 'Gestionada', 'Listo papi, no lo vuelvas a hacer', '2026-09-14 01:40:51', '2026-09-14 01:41:31');
...
(20, 3, 'Física Básica', 'Movimiento', '<p>Ostia sisisi</p>', '9'),
...
(1, 'Carlos', 'Perez', 'carlos.prueba@icfes.local', '$2y$10$vZWZcg3toxTyznYGUHyFMuv4dVPI2gZXr/UYJ5ORN07e7qaaSQScG', '11', 12, 'assets/uploads/avatares/catalogo_20260914074938_10a3f5e928dc.jpg', 1, 0, 1, '2026-08-13 03:56:00', '1234567890', 2, 1, 0, 'Activo', '2026-09-14 02:00:00', '2026-09-14 01:54:47', NULL),
(2, 'Administrador', 'Jois', 'riverabricenojoeljacoba@gmail.com', '$2y$10$V7DVC.JfRWklLUUQ0NtpLe5jSugLU0IWBbM3k7l0BXDJZ56qRMf3y', '11', NULL, 'assets/uploads/perfiles/admin_2_9d10a728fc475a61.jpg', NULL, 0, 1, '2026-08-13 04:46:03', 'ADMIN001', 1, 1, 0, 'Activo', '2026-09-14 02:41:54', '2026-09-14 01:29:06', NULL),
...
(8, 'Joel', 'Rivera', 'riverabricenojoeljacob@gmail.com', '$2y$10$oYNgQwfKdSdqAVQlyA6Q4uydzYc3tGOcYYiN81dm5h3S6sB0JCMay', '11', 13, 'assets/uploads/avatares/usuario_8_80fd14d7de0ad64d.webp', NULL, 200, 2, '2026-08-28 07:10:19', '1073533196', 2, 1, 0, 'Activo', '2026-09-09 09:15:31', '2026-09-02 09:36:00', NULL);
...
--
-- Indices de la tabla `configuracion_gamificacion`
--
ALTER TABLE `configuracion_gamificacion`
  ADD PRIMARY KEY (`id_configuracion`),
  ADD UNIQUE KEY `uq_gam_clave` (`clave`);
...
ALTER TABLE `solicitudes_recuperacion`
  ...
  ADD KEY `idx_recuperacion_usuario_estado` (`id_usuario`,`estado`);
...
--
-- AUTO_INCREMENT de la tabla `configuracion_gamificacion`
--
ALTER TABLE `configuracion_gamificacion`
...
--
ALTER TABLE `progreso`
  MODIFY `id_progreso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `temas`
  MODIFY `id_tema` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
-- Filtros para la tabla `avatares`
--
ALTER TABLE `avatares`
  ADD CONSTRAINT `fk_avatares_nivel` FOREIGN KEY (`id_nivel`) REFERENCES `niveles` (`id_nivel`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `insignias`
  ADD CONSTRAINT `fk_insignias_materia` FOREIGN KEY (`id_materia`) REFERENCES `materias` (`id_materia`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `solicitudes_recuperacion`
  ADD CONSTRAINT `fk_recuperacion_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE;
